...
(defn make-properties
  ...
  (let [kys [:circled$ :x :y :energy :subenv] ; TODO CHANGE FOR NEW FIELDS
        circled-idx 0 ; HARDCODED INDEX for circled$ field
        descriptions ["Boolean indicating whether circled in GUI"       ; TODO CHANGE FOR NEW FIELDS
        ...
        types [java.lang.Boolean java.lang.Integer java.lang.Integer java.lang.Double java.lang.String] ; TODO CHANGE FOR NEW FIELDS
        read-write [true false false false false] ; allow user to turn off circled in UI ; TODO CHANGE FOR NEW FIELDS
        names (mapv name kys)
        num-properties (count kys)
        hidden     (vec (repeat num-properties false)) ; no properties specified here are to be hidden from GUI
        ;; THIS IS THE KEY MOVE: Look up the current version of this agent by id:
